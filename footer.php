			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-8">
					<div class="footer__item">
						...
						<?php if (get_locale() == 'es_ES') { echo do_shortcode('[contact-form-7 id="912" title="newsletter" html_class="newsletter"]');} if (get_locale() == 'en_US') { echo do_shortcode('[contact-form-7 id="1143" title="newsletter in english" html_class="newsletter"]');}?>
